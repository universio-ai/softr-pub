<div id="universio-classroom" data-uni-root="classroom">
    <!-- Softr data holder -->
    <span id="uni-data" data-graph="{{ record.graph_id }}" data-node="{{ record.node_id }}" style="display: none;"> </span>
</div>
...
<!-- Keep your visual overrides that make the input row the “card” -->
